...
int prodResults(TString dir="ratioScan/selectPairsDir/turnons/EG20/", TString file="eff_EG20_tagWP80_probeWP80_EB_N_vs_EE_N_fitres.root", TString namews="workspace", int nbdata=35000, double et_plateau=100, 
		bool draw=false, bool verbose=false) 
{
