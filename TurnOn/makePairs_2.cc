...
void makePairs_2(int nEntries, string dirOut, TString dirIn, TString data, string nameChain, TString RunPhase, bool debug);
...
void makePairs_2(int nEntries,  string dirOut, TString dirIn, TString data, string nameChain,  TString RunPhase, bool debug){
  ...
  string eosdir; 
  eosdir="root://eoscms//eos/cms/store/user/taroni/SingleEle_run2012D/DoubleElectron/crab_ECAL_LASER_CORRECTION_D_new/151214_160434/0000/";
  //eosdir=dirIn;
  vector<string> files; 
  files.push_back("tree_2012D.root");
