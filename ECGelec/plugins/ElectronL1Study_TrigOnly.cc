...
// ====================================================================================
ElectronL1Study_TrigOnly::ElectronL1Study_TrigOnly(const edm::ParameterSet& iConfig)
{
  //////////////////////
  // INPUT PARAMETERS //
  //////////////////////
...
// ====================================================================================
ElectronL1Study_TrigOnly::~ElectronL1Study_TrigOnly()
// ====================================================================================
{
  //delete m_electrons ;
  //delete m_HLT_pathsV;
...
// ====================================================================================
void ElectronL1Study_TrigOnly::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
// ====================================================================================
{
...
// ====================================================================================
void ElectronL1Study_TrigOnly::FillEvent (const edm::Event& iEvent, const edm::EventSetup& iSetup)
// ====================================================================================
{
...
// ====================================================================================
void ElectronL1Study_TrigOnly::FillTrigger (const edm::Event& iEvent, const edm::EventSetup& iSetup)
// ====================================================================================
{
  ...
  */
  ...
  if( GetL1M_ ) {
    ...
    if(PrintDebug_) cout << "N L1 emul candidate iso : " << _trig_L1emIso_N_M << endl;
    counter = 0;
    ...
    if(PrintDebug_) cout << "N L1 emul candidate noniso : " << _trig_L1emNonIso_N_M << endl;
    counter = 0;
  ...
  if(PrintDebug_) {
    ...
    cout << "DATA L1 Candidates" << endl
	 << "ISO : ";
    for(int iC=0 ; iC<_trig_L1emIso_N ; iC++)
      cout << "(" << _trig_L1emIso_ieta[iC] << ";" << _trig_L1emIso_iphi[iC] << ")=" << _trig_L1emIso_rank[iC] << " | ";

    cout << endl
	 << "NON ISO : ";
    for(int iC=0 ; iC<_trig_L1emNonIso_N ; iC++)
      cout << "(" << _trig_L1emNonIso_ieta[iC] << ";" << _trig_L1emNonIso_iphi[iC] << ")=" << _trig_L1emNonIso_rank[iC] << " | ";

    cout << endl
	 << "EMUL L1 Candidates" << endl
	 << "ISO : ";
    for(int iC=0 ; iC<_trig_L1emIso_N_M ; iC++)
      cout << "(" << _trig_L1emIso_ieta_M[iC] << ";" << _trig_L1emIso_iphi_M[iC] << ")=" << _trig_L1emIso_rank_M[iC] << " | ";

    cout << endl
	 << "NON ISO : ";
    for(int iC=0 ; iC<_trig_L1emNonIso_N_M ; iC++)
      cout << "(" << _trig_L1emNonIso_ieta_M[iC] << ";" << _trig_L1emNonIso_iphi_M[iC] << ")=" << _trig_L1emNonIso_rank_M[iC] << " | ";
...
// ====================================================================================
void ElectronL1Study_TrigOnly::FillSpikes(const edm::Event& iEvent, const edm::EventSetup& iSetup)
// ====================================================================================
{
...
// ====================================================================================
void ElectronL1Study_TrigOnly::FillEle(const edm::Event& iEvent, const edm::EventSetup& iSetup)
// ====================================================================================
{
...
// ====================================================================================
void ElectronL1Study_TrigOnly::FillSuperClusters(const edm::Event& iEvent, const edm::EventSetup& iSetup)
// ====================================================================================
{
...
// ====================================================================================
void ElectronL1Study_TrigOnly::Init()
// ====================================================================================
{
...
// ====================================================================================
void ElectronL1Study_TrigOnly::beginJob(const edm::ParameterSet& conf) { }
// ====================================================================================

// ====================================================================================
void ElectronL1Study_TrigOnly::endJob() { }
// ====================================================================================
