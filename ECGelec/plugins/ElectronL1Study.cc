...
ElectronL1Study::ElectronL1Study(const edm::ParameterSet& iConfig)
{
  ...
  GetHcalTP_   = iConfig.getUntrackedParameter<bool>("GetHcalTP");
  // Masking
  GetStripMask_ = iConfig.getUntrackedParameter<bool>("GetStripMask");
  GetXtalMask_  = iConfig.getUntrackedParameter<bool>("GetXtalMask");
  ...
  hcalTPGs_               = iConfig.getParameter<edm::InputTag>("TP_HCAL") ;
  // Compute H/E
  ...
  GetSLHC_L1_      = iConfig.getUntrackedParameter<bool>("GetL1_SLHC");
  ...
  GetVertices_       = iConfig.getUntrackedParameter<bool>("GetVertices");
  // Printouts
...
//   trackAssociator_.useDefaultPropagator();
  ...
  // HCAL TP
  mytree_->Branch("trig_tower_hcal_N", &_trig_tower_hcal_N, "trig_tower_hcal_N/I");
  mytree_->Branch("trig_tower_hcal_ieta",  &_trig_tower_hcal_ieta,  "trig_tower_hcal_ieta[trig_tower_N]/I");
  mytree_->Branch("trig_tower_hcal_iphi",  &_trig_tower_hcal_iphi,  "trig_tower_hcal_iphi[trig_tower_N]/I");
  mytree_->Branch("trig_tower_hcal_et",  &_trig_tower_hcal_et,  "trig_tower_hcal_et[trig_tower_N]/I");
  mytree_->Branch("trig_tower_hcal_FG",  &_trig_tower_hcal_FG,  "trig_tower_hcal_FG[trig_tower_N]/I");

  // Trigger
  mytree_->Branch ("trig_HLT_triggered", &m_HLT_triggered, 256000,0);
  mytree_->Branch ("trig_HLT_pathsV", &m_HLT_pathsV, 256000,0);
  mytree_->Branch ("trig_HLT_pathsV_check", &m_HLT_pathsV_check, 256000,0);
  //
  ...
  mytree_->Branch("trig_L1emNonIso_et_M",    &_trig_L1emNonIso_et_M,    "trig_L1emNonIso_et_M[4]/D");
   ...
   // L1 candidates : modified collection
  mytree_->Branch("trig_L1emIso_N_SLHC",     &_trig_L1emIso_N_SLHC,     "trig_L1emIso_N_SLHC/I");
  mytree_->Branch("trig_L1emIso_ieta_SLHC",  &_trig_L1emIso_ieta_SLHC,  "trig_L1emIso_ieta_SLHC[50]/I");
  mytree_->Branch("trig_L1emIso_iphi_SLHC",  &_trig_L1emIso_iphi_SLHC,  "trig_L1emIso_iphi_SLHC[50]/I");
  mytree_->Branch("trig_L1emIso_rank_SLHC",  &_trig_L1emIso_rank_SLHC,  "trig_L1emIso_rank_SLHC[50]/I");
  mytree_->Branch("trig_L1emIso_eta_SLHC",   &_trig_L1emIso_eta_SLHC,   "trig_L1emIso_eta_SLHC[50]/D");
  mytree_->Branch("trig_L1emIso_phi_SLHC",   &_trig_L1emIso_phi_SLHC,   "trig_L1emIso_phi_SLHC[50]/D");
  mytree_->Branch("trig_L1emIso_energy_SLHC",&_trig_L1emIso_energy_SLHC,"trig_L1emIso_energy_SLHC[50]/D");
  mytree_->Branch("trig_L1emIso_et_SLHC",    &_trig_L1emIso_et_SLHC,    "trig_L1emIso_et_SLHC[50]/D");
  //
  mytree_->Branch("trig_L1emNonIso_N_SLHC",     &_trig_L1emNonIso_N_SLHC,     "trig_L1emNonIso_N/I");
  mytree_->Branch("trig_L1emNonIso_ieta_SLHC",  &_trig_L1emNonIso_ieta_SLHC,  "trig_L1emNonIso_ieta_SLHC[50]/I");
  mytree_->Branch("trig_L1emNonIso_iphi_SLHC",  &_trig_L1emNonIso_iphi_SLHC,  "trig_L1emNonIso_iphi_SLHC[50]/I");
  mytree_->Branch("trig_L1emNonIso_rank_SLHC",  &_trig_L1emNonIso_rank_SLHC,  "trig_L1emNonIso_rank_SLHC[50]/I");
  mytree_->Branch("trig_L1emNonIso_eta_SLHC",   &_trig_L1emNonIso_eta_SLHC,   "trig_L1emNonIso_eta_SLHC[50]/D");
  mytree_->Branch("trig_L1emNonIso_phi_SLHC",   &_trig_L1emNonIso_phi_SLHC,   "trig_L1emNonIso_phi_SLHC[50]/D");
  mytree_->Branch("trig_L1emNonIso_energy_SLHC",&_trig_L1emNonIso_energy_SLHC,"trig_L1emNonIso_energy_SLHC[50]/D");
  mytree_->Branch("trig_L1emNonIso_et_SLHC",    &_trig_L1emNonIso_et_SLHC,    "trig_L1emNonIso_et_SLHC[50]/D");
  
  //modif-alex
  //L1 tau candidates : modified collection
  mytree_->Branch("trig_L1tauIso_N_SLHC",     &_trig_L1tauIso_N_SLHC,     "trig_L1tauIso_N_SLHC/I");
  mytree_->Branch("trig_L1tauIso_ieta_SLHC",  &_trig_L1tauIso_ieta_SLHC,  "trig_L1tauIso_ieta_SLHC[50]/I");
  mytree_->Branch("trig_L1tauIso_iphi_SLHC",  &_trig_L1tauIso_iphi_SLHC,  "trig_L1tauIso_iphi_SLHC[50]/I");
  mytree_->Branch("trig_L1tauIso_rank_SLHC",  &_trig_L1tauIso_rank_SLHC,  "trig_L1tauIso_rank_SLHC[50]/I");
  mytree_->Branch("trig_L1tauIso_eta_SLHC",   &_trig_L1tauIso_eta_SLHC,   "trig_L1tauIso_eta_SLHC[50]/D");
  mytree_->Branch("trig_L1tauIso_phi_SLHC",   &_trig_L1tauIso_phi_SLHC,   "trig_L1tauIso_phi_SLHC[50]/D");
  mytree_->Branch("trig_L1tauIso_energy_SLHC",&_trig_L1tauIso_energy_SLHC,"trig_L1tauIso_energy_SLHC[50]/D");
  mytree_->Branch("trig_L1tauIso_et_SLHC",    &_trig_L1tauIso_et_SLHC,    "trig_L1tauIso_et_SLHC[50]/D");

  mytree_->Branch("trig_L1tauNonIso_N_SLHC",     &_trig_L1tauNonIso_N_SLHC,     "trig_L1tauNonIso_N/I");
  mytree_->Branch("trig_L1tauNonIso_ieta_SLHC",  &_trig_L1tauNonIso_ieta_SLHC,  "trig_L1tauNonIso_ieta_SLHC[50]/I");
  mytree_->Branch("trig_L1tauNonIso_iphi_SLHC",  &_trig_L1tauNonIso_iphi_SLHC,  "trig_L1tauNonIso_iphi_SLHC[50]/I");
  mytree_->Branch("trig_L1tauNonIso_rank_SLHC",  &_trig_L1tauNonIso_rank_SLHC,  "trig_L1tauNonIso_rank_SLHC[50]/I");
  mytree_->Branch("trig_L1tauNonIso_eta_SLHC",   &_trig_L1tauNonIso_eta_SLHC,   "trig_L1tauNonIso_eta_SLHC[50]/D");
  mytree_->Branch("trig_L1tauNonIso_phi_SLHC",   &_trig_L1tauNonIso_phi_SLHC,   "trig_L1tauNonIso_phi_SLHC[50]/D");
  mytree_->Branch("trig_L1tauNonIso_energy_SLHC",&_trig_L1tauNonIso_energy_SLHC,"trig_L1tauNonIso_energy_SLHC[50]/D");
  mytree_->Branch("trig_L1tauNonIso_et_SLHC",    &_trig_L1tauNonIso_et_SLHC,    "trig_L1tauNonIso_et_SLHC[50]/D");
  ...
  //
  // Strip masking
  mytree_->Branch("trig_strip_mask_N", &_trig_strip_mask_N, "trig_strip_mask_N/I");
  mytree_->Branch("trig_strip_mask_TTieta", &_trig_strip_mask_TTieta, "trig_strip_mask_TTieta[trig_strip_mask_N]/I");
  mytree_->Branch("trig_strip_mask_TTiphi", &_trig_strip_mask_TTiphi, "trig_strip_mask_TTiphi[trig_strip_mask_N]/I");
  mytree_->Branch("trig_strip_mask_StripID", &_trig_strip_mask_StripID, "trig_strip_mask_StripID[trig_strip_mask_N]/I");
  mytree_->Branch("trig_strip_mask_PseudoStripID", &_trig_strip_mask_PseudoStripID, "trig_strip_mask_PseudoStripID[trig_strip_mask_N]/I");
  mytree_->Branch("trig_strip_mask_TccID", &_trig_strip_mask_TccID, "trig_strip_mask_TccID[trig_strip_mask_N]/I");
  mytree_->Branch("trig_strip_mask_CCU", &_trig_strip_mask_CCU, "trig_strip_mask_CCU[trig_strip_mask_N]/I");
  mytree_->Branch("trig_strip_mask_xtal_ix", &_trig_strip_mask_xtal_ix, "trig_strip_mask_xtal_ix[trig_strip_mask_N][5]/I");
  mytree_->Branch("trig_strip_mask_xtal_iy", &_trig_strip_mask_xtal_iy, "trig_strip_mask_xtal_iy[trig_strip_mask_N][5]/I");
  mytree_->Branch("trig_strip_mask_xtal_iz", &_trig_strip_mask_xtal_iz, "trig_strip_mask_xtal_iz[trig_strip_mask_N][5]/I");
  //
  // Crystal masking
  mytree_->Branch("trig_xtal_mask_N", &_trig_xtal_mask_N, "trig_xtal_mask_N/I");
  mytree_->Branch("trig_xtal_mask_ieta", &_trig_xtal_mask_ieta, "trig_xtal_mask_ieta[trig_xtal_mask_N]/I");
  mytree_->Branch("trig_xtal_mask_iphi", &_trig_xtal_mask_iphi, "trig_xtal_mask_iphi[trig_xtal_mask_N]/I");
  mytree_->Branch("trig_xtal_mask_TTieta", &_trig_xtal_mask_TTieta, "trig_xtal_mask_TTieta[trig_xtal_mask_N]/I");
  mytree_->Branch("trig_xtal_mask_TTiphi", &_trig_xtal_mask_TTiphi, "trig_xtal_mask_TTiphi[trig_xtal_mask_N]/I");
  mytree_->Branch("trig_xtal_mask_Rieta", &_trig_xtal_mask_Rieta, "trig_xtal_mask_Rieta[trig_xtal_mask_N]/I");
  mytree_->Branch("trig_xtal_mask_Riphi", &_trig_xtal_mask_Riphi, "trig_xtal_mask_Riphi[trig_xtal_mask_N]/I");
  mytree_->Branch("trig_xtal_mask_status", &_trig_xtal_mask_status, "trig_xtal_mask_status[trig_xtal_mask_N]/I");
  mytree_->Branch("trig_xtal_mask_EBEE", &_trig_xtal_mask_EBEE, "trig_xtal_mask_EBEE[trig_xtal_mask_N]/I");
  //mytree_->Branch("trig_xtal_mask_eT", &_trig_xtal_mask_eT, "trig_xtal_mask_eT[trig_xtal_mask_N]/D");
  ...
  mytree_->Branch("ele_expected_inner_hits_aod",ele_expected_inner_hits_aod,"ele_expected_inner_hits_aod[10]/I");
  ...
  //ROKO: SLHC matching Et
  mytree_->Branch("ele_L1iso_SLHC",       &_ele_L1Iso_SLHC,"ele_L1iso_SLHC[10]/I");
  mytree_->Branch("ele_L1noniso_SLHC",&_ele_L1Noniso_SLHC,"ele_L1noniso_SLHC[10]/I");
  
  mytree_->Branch("ele_L1iso_matchInd_SLHC",&_ele_L1Iso_matchInd_SLHC,"ele_L1iso_matchInd_SLHC[10]/I");
  mytree_->Branch("ele_L1noniso_matchInd_SLHC",&_ele_L1Noniso_matchInd_SLHC,"ele_L1noniso_matchInd_SLHC[10]/I");
  
  mytree_->Branch("ele_L1Iso_SLHC_TTeta",         &_ele_L1Iso_SLHC_TTeta,          "ele_L1Iso_SLHC_TTeta[10]/I");
  mytree_->Branch("ele_L1Iso_SLHC_TTphi",         &_ele_L1Iso_SLHC_TTphi,          "ele_L1Iso_SLHC_TTphi[10]/I");
  
  mytree_->Branch("ele_L1NonIso_SLHC_TTeta",         &_ele_L1NonIso_SLHC_TTeta,          "ele_L1NonIso_SLHC_TTeta[10]/I");
  mytree_->Branch("ele_L1NonIso_SLHC_TTphi",         &_ele_L1NonIso_SLHC_TTphi,          "ele_L1NonIso_SLHC_TTphi[10]/I");
  
  //modif-alex this is to check if the l1 candidate falls under the tau collection instead of EM 
  mytree_->Branch("ele_L1Tauiso_SLHC",&_ele_L1TauIso_SLHC,"ele_L1Tauiso_SLHC[10]/I");
  mytree_->Branch("ele_L1Tauiso_matchInd_SLHC",&_ele_L1TauIso_matchInd_SLHC,"ele_L1Tauiso_matchInd_SLHC[10]/I");
  mytree_->Branch("ele_L1TauIso_SLHC_TTeta",&_ele_L1TauIso_SLHC_TTeta,"ele_L1TauIso_SLHC_TTeta[10]/I");
  mytree_->Branch("ele_L1TauIso_SLHC_TTphi",&_ele_L1TauIso_SLHC_TTphi,"ele_L1TauIso_SLHC_TTphi[10]/I");
  mytree_->Branch("ele_L1Taunoniso_SLHC",&_ele_L1TauNoniso_SLHC,"ele_L1Taunoniso_SLHC[10]/I");
  mytree_->Branch("ele_L1Taunoniso_matchInd_SLHC",&_ele_L1TauNoniso_matchInd_SLHC,"ele_L1Taunoniso_matchInd_SLHC[10]/I");
  mytree_->Branch("ele_L1TauNonIso_SLHC_TTeta",&_ele_L1TauNonIso_SLHC_TTeta,"ele_L1TauNonIso_SLHC_TTeta[10]/I");
  mytree_->Branch("ele_L1TauNonIso_SLHC_TTphi",&_ele_L1TauNonIso_SLHC_TTphi,"ele_L1TauNonIso_SLHC_TTphi[10]/I");
...
// ====================================================================================
{
  ...
  if(PrintDebug_) std::cout << "[------ START ------]" << endl;

  if(PrintDebug_) std::cout << "<--- config --->" << endl << "- geometry, topology, B field" << endl;
  ...
  // if ( nRun==204250 && nLumi==754 && nEvent==950609216) interesting_event=true;
  // if ( nRun==204250 && nLumi==764 && nEvent==960622035) interesting_event=true;
  // if ( nRun==205158 && nLumi==107 && nEvent==99947703) interesting_event=true;
  // else return;

  //  interesting_event=false;
  bool interesting_event(false);//ADD

  if(interesting_event) cout << "========================================================================"<< endl; 
  if(interesting_event) cout << "nRun=" << nRun << " | nLumi=" << nLumi << " | nEvent=" << nEvent << endl;
  if(interesting_event) cout << "========================================================================"<< endl;
  ...
  mytree_->Fill();
  if(PrintDebug_) std::cout << "[------ END ------]" << endl;
...
// ====================================================================================
{
  if(PrintDebug_) cout << "<--- FillEvent() --->" << endl;
...
//   if ( nRun==205158 && nLumi==107 && nEvent==99947703) interesting_event=true;
  ...
  if(GetVertices_) {
    ...
    //    iEvent.getByType(recoBeamSpotHandle);//ORIG
    ...
    if(vtx_counter>199) { _vtx_N = 200; if(PrintDebug_) cout << "Number of primary vertices>199, vtx_N set to 200" << endl;}
  }
}
...
// ====================================================================================
{
  if(PrintDebug_) cout << "<--- FillTrigger() --->" << endl;

  /////////
  // HLT //
  /////////

  if(PrintDebug_) cout << "- Get HLT triggered paths" << endl;
  ...
  for(int iP=0 ; iP < (int)m_HLT_pathsV_check.size() ; iP++)
    m_HLT_pathsV_check[iP]=0;
  ...
  for (int iHLT=0; iHLT<static_cast<int>(triggerResultsHandle->size()); iHLT++) {	
    if (triggerResultsHandle->accept (iHLT)) {
      m_HLT_triggered.push_back(string( triggerNames.triggerName(iHLT) ));
      if( PrintDebug_HLT_ )
	...
	if( string( triggerNames.triggerName(iHLT) ).find( nad_hlt_name[iTrig] ) != string::npos) {
      ...
      // paths from config.py file (better technique)
      for(int iP=0 ; iP < (int)m_HLT_pathsV.size() ; iP++)
	if( string( triggerNames.triggerName(iHLT) ).find( m_HLT_pathsV[iP] ) != string::npos) {
	  m_HLT_pathsV_check[iP]=1;
	}
  ...
  */
  if(PrintDebug_HLT_) {
    ...
    //
    for(int iP=0 ; iP < (int)m_HLT_pathsV.size() ; iP++)
      cout << "HLT name : " << m_HLT_pathsV[iP] << " : " << m_HLT_pathsV_check[iP] << endl;
  }
  ...
  edm::Handle< l1extra::L1EmParticleCollection > emNonisolColl_SLHC ;
  edm::Handle< l1extra::L1EmParticleCollection > emIsolColl_SLHC ;  

  //modif-alex
  edm::Handle< l1extra::L1JetParticleCollection > TauNonIsolColl_SLHC ;
  edm::Handle< l1extra::L1JetParticleCollection > TauIsolColl_SLHC ;  

  int counter = 0;

  if( GetL1_ ) {
    if (PrintDebug_) cout << "************Getting the L1 Extra...." << endl; 
    ...
    if( !GetL1M_ ) {      
      ...
      if(PrintDebug_) cout << "************Getting the L1 Extra M...." << endl; 
...
//       iEvent.getByLabel(edm::InputTag("SLHCL1ExtraParticles","EGamma"), emNonisolColl_SLHC ) ;
//       iEvent.getByLabel(edm::InputTag("SLHCL1ExtraParticles","IsoEGamma"), emIsolColl_SLHC ) ;
      iEvent.getByLabel(edm::InputTag("SLHCL1ExtraParticles","Taus"), TauNonIsolColl_SLHC ) ;
      iEvent.getByLabel(edm::InputTag("SLHCL1ExtraParticles","IsoTaus"), TauIsolColl_SLHC ) ;


      //modif-roko  to include Jean-Baptiste new clustering without isolation for the moment 2013July13
      iEvent.getByLabel(edm::InputTag("SLHCL1ExtraParticlesNewClustering", "EGamma"), emNonisolColl_SLHC ) ;
      iEvent.getByLabel(edm::InputTag("SLHCL1ExtraParticlesNewClustering", "EGamma"), emIsolColl_SLHC ) ;
//       iEvent.getByLabel(edm::InputTag("SLHCL1ExtraParticlesNewClustering", "EGamma"), TauNonIsolColl_SLHC ) ;
//       iEvent.getByLabel(edm::InputTag("SLHCL1ExtraParticlesNewClustering", "EGamma"), TauIsolColl_SLHC ) ;

      
      

      if(PrintDebug_) cout << "************Getting the L1 Extra SLHC...." << endl; 
  ...
  // DATA L1 CANDIDATES //
  if( GetL1_ ) {  
    if(PrintDebug_) cout << "- Get data L1 candidates" << endl;
	...
	_trig_L1emIso_rank[counter] = (int)( emItr->et() );
      ...
      if (PrintDebug_) cout <<"L1 Candidate  Iso (eta,phi,et) "  
			    << _trig_L1emIso_eta[counter]<<" " 
			    << _trig_L1emIso_phi[counter]<<" " 
			    << _trig_L1emIso_et[counter] << endl;
      if (PrintDebug_) cout <<"L1 Candidate  Iso (ieta,iphi,rank) "  
			    << _trig_L1emIso_ieta[counter]<<" " 
			    << _trig_L1emIso_iphi[counter]<<" " 
			    << _trig_L1emIso_rank[counter] << endl;
      counter++;
    }
	...
	_trig_L1emNonIso_rank[counter] = (int)( emItr->et() );
      ...
      if (PrintDebug_) cout <<"L1 Candidate  NonIso (ieta,iphi,rank) "  
			    << _trig_L1emNonIso_ieta[counter]<<" " 
			    << _trig_L1emNonIso_iphi[counter]<<" " 
			    << _trig_L1emNonIso_rank[counter] << endl;
  ...
  if( GetL1M_ ) {
    if(PrintDebug_) cout << "- Get emulated L1 candidates" << endl;
	...
	_trig_L1emIso_rank_M[counter] = (int)( emItr->et() );
      ...
      if (PrintDebug_) cout <<"L1 Candidate  M Iso (ieta,iphi,rank) "  
			    << _trig_L1emIso_ieta_M[counter]<<" " 
			    << _trig_L1emIso_iphi_M[counter]<<" " 
			    << _trig_L1emIso_rank_M[counter] << endl;
	...
	_trig_L1emNonIso_rank_M[counter] = (int)( emItr->et() );
      ...
      if (PrintDebug_) cout <<"L1 Candidate  M NonIso (ieta,iphi,rank) "  
			    << _trig_L1emNonIso_ieta_M[counter]<<" " 
			    << _trig_L1emNonIso_iphi_M[counter]<<" " 
			    << _trig_L1emNonIso_rank_M[counter] << endl;
 ...
 if( GetSLHC_L1_ ) {
    if(PrintDebug_) cout << "- Get SLHC emulated L1 candidates" << endl;

    // Isolated candidates
    _trig_L1emIso_N_SLHC = emIsolColl_SLHC->size();
    if(PrintDebug_) cout << "N L1 candidate noniso : " << _trig_L1emIso_N_SLHC << endl;
    counter = 0;
    for( l1extra::L1EmParticleCollection::const_iterator emItr = emIsolColl_SLHC->begin(); emItr != emIsolColl_SLHC->end() ;++emItr) {
      _trig_L1emIso_eta_SLHC[counter]    = emItr->eta();
      _trig_L1emIso_phi_SLHC[counter]    = emItr->phi();
      _trig_L1emIso_energy_SLHC[counter] = emItr->energy();
      _trig_L1emIso_et_SLHC[counter]     = emItr->et();
      _trig_L1emIso_ieta_SLHC[counter]   = convertEtaToTT( emItr->eta() );
      _trig_L1emIso_iphi_SLHC[counter]   = convertPhiToTT( emItr->phi() );
      _trig_L1emIso_rank_SLHC[counter]   = (int)( emItr->et() );
      
   if (PrintDebug_) cout <<"L1 Candidate  SLHC Iso (eta,phi,et) "  
			 << _trig_L1emIso_eta_SLHC[counter]<<" " 
			 << _trig_L1emIso_phi_SLHC[counter]<<" " 
			 << _trig_L1emIso_et_SLHC[counter] << endl;
   if (PrintDebug_) cout <<"L1 Candidate  SLHC Iso (ieta,iphi,rank) "  
			 << _trig_L1emIso_ieta_SLHC[counter]<<" " 
			 << _trig_L1emIso_iphi_SLHC[counter]<<" " 
			 << _trig_L1emIso_rank_SLHC[counter] << endl;
   
      counter++;
    } // loop over isolated candidates

    // Non Isolated candidates
    _trig_L1emNonIso_N_SLHC = emNonisolColl_SLHC->size();
    if(PrintDebug_) cout << "N L1 candidate noniso : " << _trig_L1emNonIso_N_SLHC << endl;
    counter = 0;
    for( l1extra::L1EmParticleCollection::const_iterator emItr = emNonisolColl_SLHC->begin(); emItr != emNonisolColl_SLHC->end() ;++emItr) {
      _trig_L1emNonIso_eta_SLHC[counter]    = emItr->eta();
      _trig_L1emNonIso_phi_SLHC[counter]    = emItr->phi();
      _trig_L1emNonIso_energy_SLHC[counter] = emItr->energy();
      _trig_L1emNonIso_et_SLHC[counter]     = emItr->et();
      _trig_L1emNonIso_ieta_SLHC[counter]   = convertEtaToTT( emItr->eta() );
      _trig_L1emNonIso_iphi_SLHC[counter]   = convertPhiToTT( emItr->phi() );
      _trig_L1emNonIso_rank_SLHC[counter]   = (int)( emItr->et() );
      
      if (PrintDebug_) cout <<"L1 Candidate  SLHC NonIso (ieta,iphi,rank) "  
			    << _trig_L1emNonIso_eta_SLHC[counter]<<" " 
			    << _trig_L1emNonIso_phi_SLHC[counter]<<" " 
			    <<  _trig_L1emNonIso_et_SLHC[counter] << endl;
      if (PrintDebug_) cout <<"L1 Candidate  SLHC NonIso (ieta,iphi,rank) "  
			    << _trig_L1emNonIso_ieta_SLHC[counter]<<" "
			    << _trig_L1emNonIso_iphi_SLHC[counter] << " "
			    << _trig_L1emNonIso_rank_SLHC[counter] << endl;
    ...
    //modif-alex
    // Tau candidates
    _trig_L1tauIso_N_SLHC = TauIsolColl_SLHC->size();
    if(PrintDebug_) cout << "N L1 candidate tau : " << _trig_L1tauIso_N_SLHC << endl;
    counter = 0;
    for( l1extra::L1JetParticleCollection::const_iterator tauItr = TauIsolColl_SLHC->begin(); tauItr != TauIsolColl_SLHC->end() ;++tauItr) {
      _trig_L1tauIso_eta_SLHC[counter]    = tauItr->eta();
      _trig_L1tauIso_phi_SLHC[counter]    = tauItr->phi();
      _trig_L1tauIso_energy_SLHC[counter] = tauItr->energy();
      _trig_L1tauIso_et_SLHC[counter]     = tauItr->et();
      _trig_L1tauIso_ieta_SLHC[counter]   = convertEtaToTT( tauItr->eta() );
      _trig_L1tauIso_iphi_SLHC[counter]   = convertPhiToTT( tauItr->phi() );
      _trig_L1tauIso_rank_SLHC[counter]   = (int)( tauItr->et() );

      if (PrintDebug_) cout <<"L1 Candidate TAUS SLHC Iso (ieta,iphi,rank) "  
			    << _trig_L1tauIso_eta_SLHC[counter]<<" "
			    << _trig_L1tauIso_phi_SLHC[counter] << " "
			    << _trig_L1tauIso_et_SLHC[counter] << endl;
      if (PrintDebug_) cout <<"L1 Candidate TAUS SLHC Iso (ieta,iphi,rank) "  
			    << _trig_L1tauIso_ieta_SLHC[counter]<<" "
			    << _trig_L1tauIso_iphi_SLHC[counter]<<" "
			    << _trig_L1tauIso_rank_SLHC[counter] << endl;
      

      counter++;
    } // for loop on  Iso cand     

    //Non Iso Taus
    _trig_L1tauNonIso_N_SLHC = TauNonIsolColl_SLHC->size();
    if(PrintDebug_) cout << "N L1 candidate tau : " << _trig_L1tauNonIso_N_SLHC << endl;
    counter = 0;
    for( l1extra::L1JetParticleCollection::const_iterator tauItr = TauNonIsolColl_SLHC->begin(); tauItr != TauNonIsolColl_SLHC->end() ;++tauItr) {
      _trig_L1tauNonIso_eta_SLHC[counter]    = tauItr->eta();
      _trig_L1tauNonIso_phi_SLHC[counter]    = tauItr->phi();
      _trig_L1tauNonIso_energy_SLHC[counter] = tauItr->energy();
      _trig_L1tauNonIso_et_SLHC[counter]     = tauItr->et();
      _trig_L1tauNonIso_ieta_SLHC[counter]   = convertEtaToTT( tauItr->eta() );
      _trig_L1tauNonIso_iphi_SLHC[counter]   = convertPhiToTT( tauItr->phi() );
      _trig_L1tauNonIso_rank_SLHC[counter]   = (int)( tauItr->et() );

      if (PrintDebug_) cout <<"L1 Candidate TAUS SLHC NonIso (ieta,iphi,rank) "  
			    << _trig_L1tauNonIso_eta_SLHC[counter]<<" "
                            << _trig_L1tauNonIso_phi_SLHC[counter] << " "
                            << _trig_L1tauNonIso_et_SLHC[counter] << endl;
      if (PrintDebug_) cout <<"L1 Candidate TAUS SLHC NonIso (ieta,iphi,rank) "  
			    << _trig_L1tauNonIso_ieta_SLHC[counter]<<" "
                            << _trig_L1tauNonIso_iphi_SLHC[counter]<<" "
                            << _trig_L1tauNonIso_rank_SLHC[counter] << endl;
  ...
  // -------- //
  if( GetTP_ ) {
    if(PrintDebug_) cout << "- Get data Trigger Primitives" << endl;
    //
    ...
    for (int i=0 ; i<_trig_tower_N ; i++) {
      ...
      //int check_adc  = (d_[0].raw()&0xff) ;
      //modif-alex-end
      
//       if(check_adc < 2)  continue; //modif-alex
      
      if(PrintDebug_) cout << "loop iteration #" << i << endl;
      //EcalTriggerPrimitiveDigi d_ = (*(ecal_tp_->product()))[i]; // EcalTriggerPrimitiveDigi d //modif-alex
      ...
      if(PrintDebug_) cout << "got the ieta and iphi : " << TPtowid_.ieta() << " " << TPtowid_.iphi() << endl; // modif-Alex
      if(PrintDebug_) cout << "got the RCT ieta and iphi : " << getGCTRegionEta(TPtowid_.ieta()) << " " << getGCTRegionPhi(TPtowid_.iphi()) << endl; //modif-alex

      _trig_tower_adc[i]  = (d_[0].raw()&0xff) ;  // 0xff  <-> Et(8bits)
      if(PrintDebug_) cout << "got the adc : " << (int)(d_[0].raw()&0xff) << endl;
//       if(PrintDebug_) cout << "ROKO got the adc : " << (d_[0].compressedEt()) << endl;
      _trig_tower_sFGVB[i] = d_[0].sFGVB();       // 0=spike-like / 1=EM-like
      if(PrintDebug_) cout << "got the sFGVB : " << d_[0].sFGVB() << endl;
      if(interesting_event && ((int)(d_[0].raw()&0xff) >= 2)) printf("ECAL TPG ieta,iphi,adc: %3d,%3d,%3d\n",TPtowid_.ieta() ,TPtowid_.iphi() ,(int)(d_[0].raw()&0xff) );
  ...
  // ------------------ //
  if( GetTP_Modif_ ) {
    if(PrintDebug_) cout << "- Get zeroed Trigger Primitives" << endl;
    //
  ...
  // ------------ //
  if( GetTP_Emul_ ) {
    if(PrintDebug_) cout << "- Get emulated Trigger Primitives" << endl;
    //
    ecal_tpM_ = new edm::Handle<EcalTrigPrimDigiCollection> ;
  ...
  //------------- //
  if( GetHcalTP_ ) {
    if(PrintDebug_) cout << "- Get HCAL Trigger Primitives" << endl;
    //
    edm::Handle<HcalTrigPrimDigiCollection> hcalTPG;
    bool gotHCALTPs = iEvent.getByLabel(hcalTPGs_,hcalTPG);

    if(PrintDebug_ && !gotHCALTPs)
      cout << "<----- NadirWarning : NO HCAL TPs found" << endl;
    else {
      HcalTrigPrimDigiCollection const &onlineHcal= *(hcalTPG.product());
      HcalTrigPrimDigiCollection::const_iterator hcalIt;
      //const HcalTrigTowerDetId Htowid = hcalIt->id();

      _trig_tower_hcal_N = onlineHcal.size();
      if(PrintDebug_) cout << "HCAL TPs : N=" << _trig_tower_hcal_N << endl;
      int iHTP=0;

      for(hcalIt = onlineHcal.begin(); hcalIt != onlineHcal.end(); ++hcalIt) {
	//int hcalet = ( (hcalIt->SOI_compressedEt()) & 0xff ); //modif-alex

	if(PrintDebug_) {
	  //if(hcalet == 0) continue; //modif-alex
	  cout << hcalIt->id() << " : "
	       << "ieta=" << (hcalIt->id()).ieta() << " ; "
	       << "iphi=" << (hcalIt->id()).iphi() << " ; "
	       << "eT="   << ( (hcalIt->SOI_compressedEt()) & 0xff )
	       << endl;
	}
    
	if(interesting_event &&  ( (hcalIt->SOI_compressedEt()) & 0xff ) >=2 ) 
	        printf("HCAL TPG ieta,iphi,eT:%3d,%3d,%3d\n",(hcalIt->id()).ieta() ,(hcalIt->id()).iphi() ,( (hcalIt->SOI_compressedEt()) & 0xff ) );

	_trig_tower_hcal_ieta[iHTP] = (hcalIt->id()).ieta(); 
	_trig_tower_hcal_iphi[iHTP] = (hcalIt->id()).iphi();
	_trig_tower_hcal_et[iHTP]   = hcalIt->SOI_compressedEt(); // si besoin : ajouter &0xff dans macro
	_trig_tower_hcal_FG[iHTP]   = hcalIt->SOI_fineGrain();
      }
    }
  }
  ...
  // RCT masking //
  // ----------- //
  if(PrintDebug_) cout << "- Get RCT masking" << endl;
  //
  ...
  // Tower masking //
  // ------------- //
  if(PrintDebug_) cout << "- Get Tower masking" << endl;
  //
  ...
  for (ittpg=towerMap.begin();ittpg!=towerMap.end();++ittpg) {
	...
	nMaskedChannels++;
	if(interesting_event ) printf("ECAL TT masked ieta,iphi: %3d,%3d\n",ttId.ieta() ,ttId.iphi());
      }
  }//loop trigger towers
  ...
  edm::ESHandle< EcalElectronicsMapping > ecalElec_handle;
  ...
  if( GetStripMask_ ) {
    if(PrintDebug_) cout << "- Get Strip masking" << endl;
    //
    iSetup.get< EcalMappingRcd >().get( ecalElec_handle );
    ecalElectronicsMap_ = ecalElec_handle.product(); 
  
    iSetup.get<EcalTPGStripStatusRcd>().get(theEcalTPGStripStatus_handle);
    ecaltpgStripStatus = theEcalTPGStripStatus_handle.product();
    const EcalTPGStripStatusMap &stripMap = ecaltpgStripStatus->getMap();

    bool startst;
    int strip, pseudostrip, tt, tccid;//, ix, iy, iz;
	...
	// let's decode the ID
	strip = (int)(itSt->first/8);
	pseudostrip = (int)(strip & 0x7);
	strip /= 8;
	tt = strip & 0x7F;
	strip /= 128;
	tccid = strip & 0x7F;
	if(PrintDebug_) {
	  std::cout << " - ID = " << itSt->first
	...
	xtalId = ecalElectronicsMap_->pseudoStripConstituents(tccid, tt, pseudostrip);
  
	// fill branches
	_trig_strip_mask_StripID[iS] = (int) itSt->first ;
	_trig_strip_mask_PseudoStripID[iS] = pseudostrip ;
	_trig_strip_mask_TccID[iS] = tccid ;
	_trig_strip_mask_CCU[iS] = tt ;
	...
	for(it = xtalId.begin(); it != xtalId.end(); it++) {
	  ...
	  _trig_strip_mask_xtal_iz[iS][iXtal] = eeid.zside();
	  _trig_strip_mask_xtal_ix[iS][iXtal] = eeid.ix();
	  _trig_strip_mask_xtal_iy[iS][iXtal] = eeid.iy();

	  // fill branches

	  if(startst){
	    if(PrintDebug_) std::cout << "   TT (ieta;iphi) = (" << towid.ieta()  << ";" << towid.iphi() << ")" << endl; 
	  
	    towid = (*eTTmap_).towerOf(eeid);

	    _trig_strip_mask_TTieta[iS] = towid.ieta() ;
	    _trig_strip_mask_TTiphi[iS] = towid.iphi() ;

	    if(interesting_event ) printf("ECAL TT strip masked ieta,iphi: %3d,%3d\n",towid.ieta() ,towid.iphi());
  ...
  // ----------------------- //
  if( GetXtalMask_ ) {
    if(PrintDebug_) cout << "- Start getting crystal masking" << endl;

    edm::ESHandle<EcalTPGCrystalStatus> theEcalTPGCrystalStatus_handle;
    iSetup.get<EcalTPGCrystalStatusRcd>().get(theEcalTPGCrystalStatus_handle);
    const EcalTPGCrystalStatus * ecaltpgCrystalStatus = theEcalTPGCrystalStatus_handle.product();
    const EcalTPGCrystalStatusMap &crystalMap = ecaltpgCrystalStatus->getMap();
    ...
    //std::cout << std::endl << " masked crystals" << std::endl;;  
    /*
      EBDetId detid;
    ...
    */
	...
	for (int iphi=0; iphi<kBarlWedges; iphi++) {
	  ...
	  if(crystalMap[id.rawId()].getStatusCode() > 0) {
	    //std::cout << " EB " << id << " status "
	    //<< crystalMap[id.rawId()].getStatusCode() << std::endl;
	    // maskedEBChannels_.push_back(id);
	  
	    //theta = theBarrelGeometry_->getGeometry( id )->getPosition().theta();
	    //towid = id.tower();

	    _trig_xtal_mask_ieta[ nMaskCrystals ] = id.ieta(); 
	    _trig_xtal_mask_iphi[ nMaskCrystals ] = id.iphi();
	    _trig_xtal_mask_TTieta[ nMaskCrystals ] = id.tower_ieta();
	    _trig_xtal_mask_TTiphi[ nMaskCrystals ] = id.tower_iphi();
	    _trig_xtal_mask_Rieta[ nMaskCrystals ] = getGCTRegionEta( id.tower_ieta() );
	    _trig_xtal_mask_Riphi[ nMaskCrystals ] = getGCTRegionPhi( id.tower_iphi() );
	    _trig_xtal_mask_status[ nMaskCrystals ] = (int)( crystalMap[id.rawId()].getStatusCode() ) ;
	    _trig_xtal_mask_EBEE[ nMaskCrystals ] = 0;
	    //_trig_xtal_mask_eT[ nMaskCrystals ] = ;

	    if(PrintDebug_) cout << "  - " << id << " -> status : " << _trig_xtal_mask_status[ nMaskCrystals ] << endl;
	    nMaskCrystals++ ;
	...
	for (int iy=0; iy<kEndcWedgesY; iy++) {
	  ...
	  if(crystalMap[id.rawId()].getStatusCode() > 0) {
	    //std::cout  << " EE " << id << " status "
	    //<< crystalMap[id.rawId()].getStatusCode() << std::endl;
	    // maskedEEChannels_.push_back(id);

	    towid = (*eTTmap_).towerOf(id);

	    _trig_xtal_mask_ieta[ nMaskCrystals ] = id.ix(); 
	    _trig_xtal_mask_iphi[ nMaskCrystals ] = id.iy();
	    _trig_xtal_mask_TTieta[ nMaskCrystals ] = towid.ieta();
	    _trig_xtal_mask_TTiphi[ nMaskCrystals ] = towid.iphi();
	    _trig_xtal_mask_Rieta[ nMaskCrystals ] = getGCTRegionEta( towid.ieta() );
	    _trig_xtal_mask_Riphi[ nMaskCrystals ] = getGCTRegionPhi( towid.iphi() );
	    _trig_xtal_mask_status[ nMaskCrystals ] = (int)( crystalMap[id.rawId()].getStatusCode() ) ;
	    _trig_xtal_mask_EBEE[ nMaskCrystals ] = 1;
	    //_trig_xtal_mask_eT[ nMaskCrystals ] = ;
    ...
    _trig_xtal_mask_N = nMaskCrystals ;
  } // endif GetXtalMask_
...
// ====================================================================================
{
  ...
  if(PrintDebug_) cout << "<--- FillSpikes --->" << endl;
...
// ====================================================================================
{
  ...
  for(int i=0; i< ele_N; i++) {
    ...
    // Concordance g�om�trique track/SC
    ...
    //    ele_mva[counter]   = (*EleHandle)[i].mva() ;//ORIG
    ele_mva[counter]   = (*EleHandle)[i].mva_e_pi() ;
    ele_sigmaietaieta[counter] = (*EleHandle)[i].sigmaIetaIeta() ; 
    if(!aod_)
      //ele_expected_inner_hits[counter] = (*EleHandle)[i].gsfTrack()->trackerExpectedHitsInner().numberOfHits();//ORIG
      ele_expected_inner_hits[counter] = (*EleHandle)[i].gsfTrack()->hitPattern().numberOfHits(reco::HitPattern::MISSING_INNER_HITS);

    const reco::Track *el_track = (const reco::Track*)((*EleHandle)[i].gsfTrack().get());
    //    const reco::HitPattern& p_inner = el_track->trackerExpectedHitsInner();//ORIG
    //    ele_expected_inner_hits_aod[counter] = p_inner.numberOfHits();//ORIG

    const reco::HitPattern& p_inner = el_track->hitPattern();
    ele_expected_inner_hits_aod[counter] = p_inner.numberOfHits(reco::HitPattern::MISSING_INNER_HITS);

    /*
    cout << "EXPECTED INNER HITS : " << ele_expected_inner_hits_aod[counter] 
	 << " / not oad : "          << ele_expected_inner_hits[counter]
	 << endl;
    */
    ...
    bool interesting_event(false);//ADD     
    if(interesting_event) printf("Matching Electron et, eta, phi:  %4.2f %3.2f %3.2f\n",ele_sclEt[counter], ele_sclEta[counter], ele_sclPhi[counter]);
      ...
      for (std::vector<std::pair<DetId, float> >::const_iterator detitr = clusterDetIds.begin () ;
	   detitr != clusterDetIds.end () ; ++detitr) {
	    ...
	    if ( (detitr -> first).subdetId () == EcalBarrel) {
	      ...
	      //ROKO TMP
    // 	  etatower =  theBarrelGeometry_->getGeometry(*((DetId*)&towid))->getPosition().eta();
    // 	  phitower =  theBarrelGeometry_->getGeometry(*((DetId*)&towid))->getPosition().phi();
    // 	  cout <<"************TOWER (eta/phi) BARREL  "<< etatower<< " " <<  phitower << endl;
    ...
    // 	    etatower =  theEndcapGeometry_->getGeometry(((DetId)towid))->getPosition().eta();
    // 	    phitower =  theEndcapGeometry_->getGeometry(((DetId)towid))->getPosition().phi();
    // 	    cout <<"************TOWER (eta/phi) ENDCAP  "<< etatower<< " " <<  phitower << endl;
	      }
	      else continue;
	    }
 ...
 /*   
////////////////////////////////////////////////////////
// ROKO try to fill the regions of SLHC trigger
    map<pair<int, int>, double > map_RSLHC_et;
    map<pair<int, int>, int > map_RSLHC_ieta, map_RSLHC_iphi ;  //my convention is to have ieta, iphi of the TT in the upper left corner of the cluster
    
    for (int iTow = 0 ; iTow < 50; iTow++)
    {
      
        if (_ele_TTetVect[counter][iTow] <= 0.) continue; //just filled TTs
	
        pair<int,int> TTcoords[4] = {make_pair(_ele_TTetaVect[counter][iTow]-1,_ele_TTphiVect[counter][iTow]-1),
			       make_pair(_ele_TTetaVect[counter][iTow]-1,_ele_TTphiVect[counter][iTow]),
			       make_pair(_ele_TTetaVect[counter][iTow],_ele_TTphiVect[counter][iTow]-1),
			       make_pair(_ele_TTetaVect[counter][iTow],_ele_TTphiVect[counter][iTow])
			       };
        for (int icl = 0; icl< 4; icl++){
	  int ieta = (TTcoords[icl].first == -33) ? -999  : TTcoords[icl].first  ; 
	  if (ieta == 32) ieta= -999; //to skip these clusters
	  int iphi = (TTcoords[icl].second == 0) ? 72 : TTcoords[icl].second; //ensure to have iphi it cyclical from 1-72
	  if (ieta == -999 ) continue; //skip clusters that are on the boundary
	  if (map_RSLHC_et.count(TTcoords[icl])==0) map_RSLHC_et[TTcoordsp[icl]]   =    0.;  //crete element
	    
	  map_RSLHC_et[TTcoords] +=_ele_TTetVect[counter][iTow];
	  map_RSLHC_eta[TTcoords] =_ele_TTetaVect[counter][iTow];
	  map_RSLHC_phi[TTcoords] =_ele_TTphiVect[counter][iTow];
        
        }
    }
    //now we have a map of clusters
    //lets create a vector 
    map<pair<int, int>, double >::iterator it;
    int icl=0;
    for ( it=map_RSLHC_et.begin() ; it != map_RSLHC_et.end(); it++ )
    {
	_ele_RSLHCetaVect[counter][icl] = (*it).first.first;
	_ele_RSLHCphiVect[counter][icl] = (*it).first.second;
	_ele_RSLHCetVect[counter][icl]  = (*it).second;
	if (PrintDebug_)cout <<"SLHC region (ieta, iphi, et)" << (*it).first.first << (*it).first.first << " => " << (*it).second << endl;
	
	for(int il1=0; il1<_trig_L1emIso_N_SLHC; ++il1) {
	      int L1_ieta = _trig_L1emIso_ieta_SLHC[il1];
	      int L1_iphi = _trig_L1emIso_iphi_SLHC[il1];
	        if(
		  (L1_iphi == (_ele_RSLHCphiVect[counter][icl]-1) && L1_ieta == (_ele_RSLHCetaVect[counter][icl]-1)) ||
		  (L1_iphi == (_ele_RSLHCphiVect[counter][icl]-1) && L1_ieta == _ele_RSLHCetaVect[counter][icl]) ||
		  (L1_iphi == _ele_RSLHCphiVect[counter][icl] && L1_ieta == (_ele_RSLHCetaVect[counter][icl]-1)) ||
		  (L1_iphi == _ele_RSLHCphiVect[counter][icl] && L1_ieta == _ele_RSLHCetaVect[counter][icl])
		) 
		_ele_RSLHCL1isoVect[counter][icc] = _trig_L1emIso_rank_SLHC[il1];
	}
	
	
	for(int il1=0; il1<_trig_L1emNonIso_N_SLHC; ++il1) {
	      int L1_ieta = _trig_L1emNonIso_ieta_SLHC[il1];
	      int L1_iphi = _trig_L1emNonIso_iphi_SLHC[il1];
	        if(
		  (L1_iphi == (_ele_RSLHCphiVect[counter][icl]-1) && L1_ieta == (_ele_RSLHCetaVect[counter][icl]-1)) ||
		  (L1_iphi == (_ele_RSLHCphiVect[counter][icl]-1) && L1_ieta == _ele_RSLHCetaVect[counter][icl]) ||
		  (L1_iphi == _ele_RSLHCphiVect[counter][icl] && L1_ieta == (_ele_RSLHCetaVect[counter][icl]-1)) ||
		...
		_ele_RSLHCL1isoVect[counter][icc] = _trig_L1emNonIso_rank_SLHC[il1];
	}
...
// // // // // // // // // // /
    ...
    bool matchingSLHC = false;// modif-alex 
    for(int il1=0; il1<_trig_L1emIso_N_SLHC; ++il1) {
      if(PrintDebug_ && _trig_L1emIso_iphi_SLHC[il1] == _ele_TTphiVect[counter][iTTmax2]) 
	cout <<">>>>> L1 iso Phi same: " <<_trig_L1emIso_iphi_SLHC[il1] << endl; 
      if(PrintDebug_ && _trig_L1emIso_ieta_SLHC[il1] == _ele_TTetaVect[counter][iTTmax2]) 
	cout <<">>>>> L1 iso Eta same: " <<_trig_L1emIso_ieta_SLHC[il1] << endl; 
      
      //ROKO change jthe matching to use the candidates around the hottest TT
      /* //modif-alex
	 if(_trig_L1emIso_iphi_SLHC[il1] == _ele_TTphiVect[counter][iTTmax2] && 
	 _trig_L1emIso_ieta_SLHC[il1] == _ele_TTetaVect[counter][iTTmax2]){ 
	 _ele_L1Iso_SLHC[counter] 	= _trig_L1emIso_et_SLHC[il1];
	 _ele_L1Iso_matchInd_SLHC[counter] = il1;
	 _ele_L1Iso_SLHC_TTeta[counter]    = _trig_L1emIso_ieta_SLHC[il1];
	 _ele_L1Iso_SLHC_TTphi[counter]    = _trig_L1emIso_iphi_SLHC[il1];
	 }
      */

      //Alex matching: expanding matching region
      bool matching_eta = (_trig_L1emIso_ieta_SLHC[il1] <= (_ele_TTetaVect[counter][iTTmax2]+1)) && (_trig_L1emIso_ieta_SLHC[il1] >= (_ele_TTetaVect[counter][iTTmax2]-1));// || (_trig_L1emIso_ieta_SLHC[il1] == (_ele_TTetaVect[counter][iTTmax2]-1)); 
      bool matching_phi = (_trig_L1emIso_iphi_SLHC[il1] <= (_ele_TTphiVect[counter][iTTmax2]+1)) && (_trig_L1emIso_iphi_SLHC[il1] >= (_ele_TTphiVect[counter][iTTmax2]-1));// || (_trig_L1emIso_iphi_SLHC[il1] == (_ele_TTphiVect[counter][iTTmax2]-1)); 
      if (_trig_L1emIso_ieta_SLHC[il1]*_ele_TTetaVect[counter][iTTmax2] == -1   ) matching_eta = true; //boundary matching in eta=0 ieta=-1 and ieta=1
      if (
        (_trig_L1emIso_iphi_SLHC[il1]==72 && _ele_TTphiVect[counter][iTTmax2]==1) ||
        (_trig_L1emIso_iphi_SLHC[il1]==1 && _ele_TTphiVect[counter][iTTmax2]==72)
//               if((upperbound_phi==1 || upperbound_phi==2) && (_trig_L1emIso_iphi_SLHC[il1]==72 || _trig_L1emIso_iphi_SLHC[il1]==71)) matching_phi = true;
        ) matching_phi = true;  
      
      if(matching_eta && matching_phi) {
	_ele_L1Iso_SLHC[counter]  = _trig_L1emIso_et_SLHC[il1];
	_ele_L1Iso_matchInd_SLHC[counter] = il1;
	_ele_L1Iso_SLHC_TTeta[counter]    = _trig_L1emIso_ieta_SLHC[il1];
	_ele_L1Iso_SLHC_TTphi[counter]    = _trig_L1emIso_iphi_SLHC[il1];
	...
	if(interesting_event) {
	  printf(" L1emIso: Matched: Hottest ieta,iphi: %3d,%3d SLHC_TTieta,SLHC_TTiphi: %3d,%3d\tH_TT_et, SLHC_et: %3.2f,%3.2f \n",_ele_TTetaVect[counter][iTTmax2], _ele_TTphiVect[counter][iTTmax2],
									      _trig_L1emIso_ieta_SLHC[il1], _trig_L1emIso_iphi_SLHC[il1],
									      _ele_TTetVect[counter][iTTmax2],_trig_L1emIso_et_SLHC[il1]
									      );
	}
      }
      else if(interesting_event) {
//       cout << "-----------------NOTSLHCMATCHED-------------------" << endl; //modif-alex
      printf(" L1emIso:     Non matched: Hottest ieta,iphi: %3d,%3d SLHC_TTieta,SLHC_TTiphi: %3d,%3d\tH_TT_et, SLHC_et: %3.2f,%3.2f \n",_ele_TTetaVect[counter][iTTmax2], _ele_TTphiVect[counter][iTTmax2],
									_trig_L1emIso_ieta_SLHC[il1], _trig_L1emIso_iphi_SLHC[il1],
									_ele_TTetVect[counter][iTTmax2],_trig_L1emIso_et_SLHC[il1]	);
    }
    ...
    for(int il1=0; il1<_trig_L1emNonIso_N_SLHC; ++il1) {
      if(PrintDebug_ && _trig_L1emNonIso_iphi_SLHC[il1] == _ele_TTphiVect[counter][iTTmax2]) 
	cout <<">>>>> L1 iso Phi same: " <<_trig_L1emNonIso_iphi_SLHC[il1] << endl; 
      if(PrintDebug_ && _trig_L1emNonIso_ieta_SLHC[il1] == _ele_TTetaVect[counter][iTTmax2]) 
	cout <<">>>>> L1 iso Eta same: " <<_trig_L1emNonIso_ieta_SLHC[il1] << endl; 
      
      //Roko matching
      /* Alex-modif
	 if(_trig_L1emNonIso_iphi_SLHC[il1] == _ele_TTphiVect[counter][iTTmax2] && 
	 _trig_L1emNonIso_ieta_SLHC[il1] == _ele_TTetaVect[counter][iTTmax2]){
	 _ele_L1Noniso_SLHC[counter] = _trig_L1emNonIso_et_SLHC[il1];
	 _ele_L1Noniso_matchInd_SLHC[counter] = il1;
	 _ele_L1NonIso_SLHC_TTeta[counter] = _trig_L1emNonIso_ieta_SLHC[il1];
	 _ele_L1NonIso_SLHC_TTphi[counter] = _trig_L1emNonIso_iphi_SLHC[il1];
	 }
      */
      
      //Alex matching: expanding matching region
      bool matching_eta = (_trig_L1emNonIso_ieta_SLHC[il1] <= (_ele_TTetaVect[counter][iTTmax2]+1)) && (_trig_L1emNonIso_ieta_SLHC[il1] >= (_ele_TTetaVect[counter][iTTmax2]-1));// || (_trig_L1emNonIso_ieta_SLHC[il1] == (_ele_TTetaVect[counter][iTTmax2]-1));                          
      bool matching_phi = (_trig_L1emNonIso_iphi_SLHC[il1] <= (_ele_TTphiVect[counter][iTTmax2]+1)) && (_trig_L1emNonIso_iphi_SLHC[il1] >= (_ele_TTphiVect[counter][iTTmax2]-1));// || (_trig_L1emNonIso_iphi_SLHC[il1] == (_ele_TTphiVect[counter][iTTmax2]-1)); 
      if (_trig_L1emNonIso_ieta_SLHC[il1]*_ele_TTetaVect[counter][iTTmax2] == -1   ) matching_eta = true; //boundary matching in eta=0 ieta=-1 and ieta=1
      if (
        (_trig_L1emNonIso_iphi_SLHC[il1]==72 && _ele_TTphiVect[counter][iTTmax2]==1) ||
        (_trig_L1emNonIso_iphi_SLHC[il1]==1 && _ele_TTphiVect[counter][iTTmax2]==72)
        ) matching_phi = true;  
      if(matching_eta && matching_phi) {
	_ele_L1Noniso_SLHC[counter]          = _trig_L1emNonIso_et_SLHC[il1];
	_ele_L1Noniso_matchInd_SLHC[counter] = il1;
	...
	_ele_L1NonIso_SLHC_TTphi[counter]    = _trig_L1emNonIso_iphi_SLHC[il1];
	 if(interesting_event) {
	    printf(" L1emNonIso: Matched: Hottest ieta,iphi: %3d,%3d SLHC_TTieta,SLHC_TTiphi: %3d,%3d\tH_TT_et, SLHC_et: %3.2f,%3.2f  \n",_ele_TTetaVect[counter][iTTmax2], _ele_TTphiVect[counter][iTTmax2],
									        _trig_L1emNonIso_ieta_SLHC[il1], _trig_L1emNonIso_iphi_SLHC[il1],
									        _ele_TTetVect[counter][iTTmax2],_trig_L1emNonIso_et_SLHC[il1]);
	  }
      }
      else if(interesting_event) {
//       cout << "-----------------NOTSLHCMATCHED-------------------" << endl; //modif-alex
      printf(" L1emNonIso:  Non matched: Hottest ieta,iphi: %3d,%3d SLHC_TTieta,SLHC_TTiphi: %3d,%3d\tH_TT_et, SLHC_et: %3.2f,%3.2f  \n",_ele_TTetaVect[counter][iTTmax2], _ele_TTphiVect[counter][iTTmax2],
									_trig_L1emNonIso_ieta_SLHC[il1], _trig_L1emNonIso_iphi_SLHC[il1],
									_ele_TTetVect[counter][iTTmax2],_trig_L1emNonIso_et_SLHC[il1]);
    }
    ...
    //checking the tau isolated list
    for(int il1=0; il1<_trig_L1tauIso_N_SLHC; ++il1) {
      if(PrintDebug_ && _trig_L1tauIso_iphi_SLHC[il1] == _ele_TTphiVect[counter][iTTmax2])
        cout <<">>>>> L1 iso Phi same: " <<_trig_L1tauIso_iphi_SLHC[il1] << endl;
      if(PrintDebug_ && _trig_L1tauIso_ieta_SLHC[il1] == _ele_TTetaVect[counter][iTTmax2])
        cout <<">>>>> L1 iso Eta same: " <<_trig_L1tauIso_ieta_SLHC[il1] << endl;
      bool matching_eta = (_trig_L1tauIso_ieta_SLHC[il1] <= (_ele_TTetaVect[counter][iTTmax2]+1)) && (_trig_L1tauIso_ieta_SLHC[il1] >= (_ele_TTetaVect[counter][iTTmax2]-1));
      bool matching_phi = (_trig_L1tauIso_iphi_SLHC[il1] <= (_ele_TTphiVect[counter][iTTmax2]+1)) && (_trig_L1tauIso_iphi_SLHC[il1] >= (_ele_TTphiVect[counter][iTTmax2]-1));
      
      if (_trig_L1tauIso_ieta_SLHC[il1]*_ele_TTetaVect[counter][iTTmax2] == -1   ) matching_eta = true; //boundary matching in eta=0 ieta=-1 and ieta=1
      if (
        (_trig_L1tauIso_iphi_SLHC[il1]==72 && _ele_TTphiVect[counter][iTTmax2]==1) ||
        (_trig_L1tauIso_iphi_SLHC[il1]==1 && _ele_TTphiVect[counter][iTTmax2]==72)
        ) matching_phi = true;  
      
      if(matching_eta && matching_phi) {
        _ele_L1TauIso_SLHC[counter]          = _trig_L1tauIso_et_SLHC[il1];
        _ele_L1TauIso_matchInd_SLHC[counter] = il1;
        _ele_L1TauIso_SLHC_TTeta[counter]    = _trig_L1tauIso_ieta_SLHC[il1];
        _ele_L1TauIso_SLHC_TTphi[counter]    = _trig_L1tauIso_iphi_SLHC[il1];
        if(interesting_event) {
	printf(" L1TauIso: Matched: Hottest ieta,iphi: %3d,%3d SLHC_TTieta,SLHC_TTiphi: %3d,%3d\tH_TT_et, SLHC_et: %3.2f,%3.2f \n",_ele_TTetaVect[counter][iTTmax2], _ele_TTphiVect[counter][iTTmax2],
									    _trig_L1tauIso_ieta_SLHC[il1], _trig_L1tauIso_iphi_SLHC[il1],
									    _ele_TTetVect[counter][iTTmax2],_trig_L1tauIso_et_SLHC[il1]
									    );
        }
      }
      else if(interesting_event) {
//       cout << "-----------------NOTSLHCMATCHED-------------------" << endl; //modif-alex
	printf(" L1TauIso:    Non matched: Hottest ieta,iphi: %3d,%3d SLHC_TTieta,SLHC_TTiphi: %3d,%3d\tH_TT_et, SLHC_et: %3.2f,%3.2f \n",_ele_TTetaVect[counter][iTTmax2], 
									_ele_TTphiVect[counter][iTTmax2],
									_trig_L1tauIso_ieta_SLHC[il1], _trig_L1tauIso_iphi_SLHC[il1],
									_ele_TTetVect[counter][iTTmax2],_trig_L1tauIso_et_SLHC[il1]
									);
      }

    }//loop l1SLHC isolated tau     
    
    //now non isolated taus
    for(int il1=0; il1<_trig_L1tauNonIso_N_SLHC; ++il1) {
      if(PrintDebug_ && _trig_L1tauNonIso_iphi_SLHC[il1] == _ele_TTphiVect[counter][iTTmax2])
        cout <<">>>>> L1 iso Phi same: " <<_trig_L1tauNonIso_iphi_SLHC[il1] << endl;
      if(PrintDebug_ && _trig_L1tauNonIso_ieta_SLHC[il1] == _ele_TTetaVect[counter][iTTmax2])
	cout <<">>>>> L1 iso Eta same: " <<_trig_L1tauNonIso_ieta_SLHC[il1] << endl;
      bool matching_eta = (_trig_L1tauNonIso_ieta_SLHC[il1] <= (_ele_TTetaVect[counter][iTTmax2]+1)) && (_trig_L1tauNonIso_ieta_SLHC[il1] >= (_ele_TTetaVect[counter][iTTmax2]-1));
      bool matching_phi = (_trig_L1tauNonIso_iphi_SLHC[il1] <= (_ele_TTphiVect[counter][iTTmax2]+1)) && (_trig_L1tauNonIso_iphi_SLHC[il1] >= (_ele_TTphiVect[counter][iTTmax2]-1));
          
      if (_trig_L1tauNonIso_ieta_SLHC[il1]*_ele_TTetaVect[counter][iTTmax2] == -1   ) matching_eta = true; //boundary matching in eta=0 ieta=-1 and ieta=1
      if (
        (_trig_L1tauNonIso_iphi_SLHC[il1]==72 && _ele_TTphiVect[counter][iTTmax2]==1) ||
        (_trig_L1tauNonIso_iphi_SLHC[il1]==1 && _ele_TTphiVect[counter][iTTmax2]==72)
        ) matching_phi = true;  
      
      if(matching_eta && matching_phi) {
        _ele_L1TauNoniso_SLHC[counter]          = _trig_L1tauNonIso_et_SLHC[il1];
        _ele_L1TauNoniso_matchInd_SLHC[counter] = il1;
        _ele_L1TauNonIso_SLHC_TTeta[counter]    = _trig_L1tauNonIso_ieta_SLHC[il1];
        _ele_L1TauNonIso_SLHC_TTphi[counter]    = _trig_L1tauNonIso_iphi_SLHC[il1];
        if(interesting_event) {
	printf(" L1TauNonIso: Matched: Hottest ieta,iphi: %3d,%3d SLHC_TTieta,SLHC_TTiphi: %3d,%3d\tH_TT_et, SLHC_et: %3.2f,%3.2f \n",_ele_TTetaVect[counter][iTTmax2], _ele_TTphiVect[counter][iTTmax2],
									    _trig_L1tauNonIso_ieta_SLHC[il1], _trig_L1tauNonIso_iphi_SLHC[il1],
									    _ele_TTetVect[counter][iTTmax2],_trig_L1tauNonIso_et_SLHC[il1]
									    );
        }
      }
      else if(interesting_event) {
//       cout << "-----------------NOTSLHCMATCHED-------------------" << endl; //modif-alex
      printf(" L1TauNonIso: Non matched: Hottest ieta,iphi: %3d,%3d SLHC_TTieta,SLHC_TTiphi: %3d,%3d\tH_TT_et, SLHC_et: %3.2f,%3.2f \n",_ele_TTetaVect[counter][iTTmax2], _ele_TTphiVect[counter][iTTmax2],
									_trig_L1tauNonIso_ieta_SLHC[il1], _trig_L1tauNonIso_iphi_SLHC[il1],
									_ele_TTetVect[counter][iTTmax2],_trig_L1tauNonIso_et_SLHC[il1]);
      }
    }//loop l1SLHC non isolated tau
    
    if (PrintDebug_) cout << ">>>>>>>>>>> Et SLHCiso (Offline /  L1 )    : " 
			  << ele_sclEt[counter] << " " << _ele_L1Iso_SLHC[counter] << endl;
    if (PrintDebug_) cout << ">>>>>>>>>>> Et SLHCnoniso (Offline /  L1 ) : " 
			  << ele_sclEt[counter] << " " << _ele_L1Noniso_SLHC[counter] << endl;	  

    //modif-alex 
    if (PrintDebug_) cout << ">>>>>>>>>>> Et SLHC TAU iso (Offline /  L1 )    : " 
			  << ele_sclEt[counter] << " " << _ele_L1TauIso_SLHC[counter] << endl;
    if (PrintDebug_) cout << ">>>>>>>>>>> Et SLHC TAU noniso (Offline /  L1 ) : " 
			  << ele_sclEt[counter] << " " << _ele_L1TauNoniso_SLHC[counter] << endl;	  
	  
    
    
    if (interesting_event) cout << ">>>>>>>>>>> Et SLHCiso (Offline /  L1 )    : " 
			  << ele_sclEt[counter] << " " << _ele_L1Iso_SLHC[counter] << endl;
    if (interesting_event) cout << ">>>>>>>>>>> Et SLHCnoniso (Offline /  L1 ) : " 
			  << ele_sclEt[counter] << " " << _ele_L1Noniso_SLHC[counter] << endl;	  

    //modif-alex 
    if (interesting_event) cout << ">>>>>>>>>>> Et SLHC TAU iso (Offline /  L1 )    : " 
			  << ele_sclEt[counter] << " " << _ele_L1TauIso_SLHC[counter] << endl;
    if (interesting_event) cout << ">>>>>>>>>>> Et SLHC TAU noniso (Offline /  L1 ) : " 
			  << ele_sclEt[counter] << " " << _ele_L1TauNoniso_SLHC[counter] << endl;	  
...
// // // // // // // // // // // // 	  
    ...
    //if (PrintDebug_) cout << ">>>>>>>>>>> Et CURRiso (Offline /  L1 )    : " << ele_sclEt[counter] << " " << _ele_RCTL1iso[counter] << endl;
    //if (PrintDebug_) cout << ">>>>>>>>>>> Et CURRnoniso (Offline /  L1 ) : " << ele_sclEt[counter] << " " << _ele_RCTL1noniso[counter] << endl;	  
    //modif-alex
    if(PrintDebug_) cout << "tower max electron=" << _ele_TTetaVect[counter][iTTmax2] << " " << _ele_TTphiVect[counter][iTTmax2] << endl;
    if (PrintDebug_) cout << ">>>>>>>>>>> Et CURRiso (Offline /  L1 )    : " << ele_sclEt[counter] << " RCTeta=" << _ele_RCTeta[counter] << " RCTphi="<< _ele_RCTphi[counter] << " L1=" << _ele_RCTL1iso[counter] << endl;
    if (PrintDebug_) cout << ">>>>>>>>>>> Et CURRnoniso (Offline /  L1 ) : " << ele_sclEt[counter] << " RCTeta=" << _ele_RCTeta[counter] << " RCTphi="<< _ele_RCTphi[counter] << " L1=" << _ele_RCTL1noniso[counter] << endl;	  
...
// ====================================================================================
{
  if(PrintDebug_) cout << "<--- FillSuperClusters() --->" << endl;
  ...
  for( reco::SuperClusterCollection::const_iterator isc=sc_coll_EB->begin(); isc!=sc_coll_EB->end(); isc++) {
    ...
    // Iso ECAL
    //EcalRecHitMetaCollection ecalBarrelHits(*reducedEBRecHits); //ORIG
    //EgammaRecHitIsolation ecalBarrelIsol03( egIsoConeSizeOutSmall,egIsoConeSizeInBarrel,egIsoJurassicWidth, //ORIG
    //					    egIsoPtMinBarrel,egIsoEMinBarrel,theCaloGeom_,&ecalBarrelHits, //ORIG
    //					    sevLevel.product(),DetId::Ecal ); //ORIG
    ...
    //counter  = phoIso.getNumberTracks(newPhoton); //ORIG
    //ptSum    = phoIso.getPtTracks(newPhoton); //ORIG
    std::pair<int,double> res = phoIso.getIso(newPhoton);
    counter = res.first;
    ptSum = res.second;
    trkiso_hc_03 = ptSum;
  ...
  if(index_sc>24) { _sc_N[0] = 25; if(PrintDebug_) cout << "Number of SuperCluster > 25; _sc_N set to 25" << endl;}
  ...
  for( reco::SuperClusterCollection::const_iterator isc=sc_coll_EE->begin(); isc!=sc_coll_EE->end(); isc++) { 
    ...
    // Iso ECAL
    //EcalRecHitMetaCollection ecalEndcapHits(*reducedEERecHits); //ORIG
    //EgammaRecHitIsolation ecalEndcapIsol03(egIsoConeSizeOutSmall,egIsoConeSizeInEndcap,egIsoJurassicWidth, //ORIG
    //					   egIsoPtMinEndcap,egIsoEMinEndcap,theCaloGeom_,&ecalEndcapHits,sevLevel.product(),DetId::Ecal); //ORIG
  ...
  if(index_sc_EE>24) { _sc_N[1] = 25; if(PrintDebug_) cout << "Number of SuperCluster > 25; _sc_N set to 25" << endl;}
...
// ====================================================================================
{
  ...
  _trig_L1emIso_N_SLHC  = 0; 
  _trig_L1emNonIso_N_SLHC = 0;
  ;
  ...
  for(int il1=0 ; il1<50; il1++) {

    _trig_L1emIso_ieta_SLHC[il1] = 0; 
    _trig_L1emIso_iphi_SLHC[il1] = 0; 
    _trig_L1emIso_rank_SLHC[il1] = 0; 
    _trig_L1emIso_eta_SLHC[il1]    = 0.; 
    _trig_L1emIso_phi_SLHC[il1]   = 0.; 
    _trig_L1emIso_energy_SLHC[il1] = 0.; 
    _trig_L1emIso_et_SLHC[il1]     = 0.; 
    
    
    _trig_L1emNonIso_ieta_SLHC[il1] = 0; 
    _trig_L1emNonIso_iphi_SLHC[il1] = 0; 
    _trig_L1emNonIso_rank_SLHC[il1] = 0; 
    _trig_L1emNonIso_eta_SLHC[il1]    = 0.; 
    _trig_L1emNonIso_phi_SLHC[il1]   = 0.; 
    _trig_L1emNonIso_energy_SLHC[il1] = 0.; 
    _trig_L1emNonIso_et_SLHC[il1]     = 0.; 

    //modif-alex 
    _trig_L1tauIso_ieta_SLHC[il1] = 0;
    _trig_L1tauIso_iphi_SLHC[il1] = 0;
    _trig_L1tauIso_rank_SLHC[il1] = 0;
    _trig_L1tauIso_eta_SLHC[il1]    = 0.;
    _trig_L1tauIso_phi_SLHC[il1]    = 0.;
    _trig_L1tauIso_energy_SLHC[il1] = 0.;
    _trig_L1tauIso_et_SLHC[il1]     = 0.;


    _trig_L1tauNonIso_ieta_SLHC[il1] = 0;
    _trig_L1tauNonIso_iphi_SLHC[il1] = 0;
    _trig_L1tauNonIso_rank_SLHC[il1] = 0;
    _trig_L1tauNonIso_eta_SLHC[il1]    = 0.;
    _trig_L1tauNonIso_phi_SLHC[il1]    = 0.;
    _trig_L1tauNonIso_energy_SLHC[il1] = 0.;
    _trig_L1tauNonIso_et_SLHC[il1]     = 0.;
  }
  ...
  for(int i=0 ; i<4032 ; i++) {
    ...
    _trig_tower_hcal_ieta[i]=-999;
    _trig_tower_hcal_iphi[i]=-999;
    _trig_tower_hcal_et[i]=-999;
    _trig_tower_hcal_FG[i]=-999; 
  }
  ...
  for(int i=0 ; i<1000 ; i++) {
    _trig_strip_mask_TTieta[i] = -999;
    _trig_strip_mask_TTiphi[i] = -999;
    _trig_strip_mask_status[i] = -999;
    _trig_strip_mask_StripID[i] = -999;
    _trig_strip_mask_PseudoStripID[i] = -999;
    _trig_strip_mask_TccID[i] = -999;
    _trig_strip_mask_CCU[i] = -999;

    for(int j=0 ; j<5 ; j++) {
      _trig_strip_mask_xtal_ix[i][j] = -999;
      _trig_strip_mask_xtal_iy[i][j] = -999;
      _trig_strip_mask_xtal_iz[i][j] = -999;
    }
    _trig_xtal_mask_ieta[i] = -999;
    _trig_xtal_mask_iphi[i] = -999;
    _trig_xtal_mask_TTieta[i] = -999;
    _trig_xtal_mask_TTiphi[i] = -999;
    _trig_xtal_mask_Rieta[i] = -999;
    _trig_xtal_mask_Riphi[i] = -999;
    _trig_xtal_mask_status[i] = -999;
    _trig_xtal_mask_EBEE[i] = -999;
  }
  ...
  for(int iEle=0 ; iEle<10 ; iEle++) {
    ...
    _ele_L1Iso_SLHC[iEle] = -999;
    _ele_L1Iso_matchInd_SLHC[iEle] = -999;
    _ele_L1Iso_SLHC_TTeta[iEle]    = -999;
    _ele_L1Iso_SLHC_TTphi[iEle]    = -999;
    _ele_L1Noniso_SLHC[iEle] = -999;
    _ele_L1Noniso_matchInd_SLHC[iEle] = -999;
    _ele_L1NonIso_SLHC_TTeta[iEle] = -999;
    _ele_L1NonIso_SLHC_TTphi[iEle] = -999;

    //modif-alex
    _ele_L1TauIso_SLHC[iEle] = -999;
    _ele_L1TauIso_matchInd_SLHC[iEle] = -999;
    _ele_L1TauIso_SLHC_TTeta[iEle]    = -999;
    _ele_L1TauIso_SLHC_TTphi[iEle]    = -999;
    _ele_L1TauNoniso_SLHC[iEle] = -999;
    _ele_L1TauNoniso_matchInd_SLHC[iEle] = -999;
    _ele_L1TauNonIso_SLHC_TTeta[iEle] = -999;
    _ele_L1TauNonIso_SLHC_TTphi[iEle] = -999;
    ...
    ele_expected_inner_hits_aod[iEle]=-1;
    //
