...
class SimpleNtpleSilvia : public edm::EDAnalyzer {
 public:
  explicit SimpleNtpleSilvia(const edm::ParameterSet&);
  ~SimpleNtpleSilvia();
 ...
 private:
  ...
  struct info {
    int towerId, towerEta, towerPhi, StripId, XtalId;
    double XtalEt; 
  } elestruc, mult55struc; 
  ...
  int _ele_TTetaVect[10][50], _ele_TTphiVect[10][50],_ele_TXtalNVect[10][50],_ele_TXtalinStripVect[10][50],_ele_TStripNVect[10][50];
  double _ele_TTetVect[10][50], _ele_TStripEtVect[10][50],_ele_TXtalEtVect[10][50];
  ...
  int _sc_multi55_TTetaVect[25][50], _sc_multi55_TTphiVect[25][50],_sc_multi55_TTRecHitsN[25][50];
