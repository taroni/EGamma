...
echo "Starting CMSSW" 
cp /afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/EGamma/ECGelec/test/eleTreeProd_Simon_newRun2Id_833.py  .
cd -
#cd \${lxbatchpwd}

echo "Starting CMSSW" 
cmsRun  eleTreeProd_Simon_newRun2Id_833.py  

mv -f  tree_testFastSim_TPG_checknow_833NEWID.root  /afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/EGamma/ECGelec/test/NewConfigue/.  
