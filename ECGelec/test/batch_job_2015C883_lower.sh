...
echo "Starting CMSSW" 
cp /afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/EGamma/ECGelec/test/eleTreeProd_Simon_newRun2Id_833lower.py  .
cd -
#cd \${lxbatchpwd}

echo "Starting CMSSW" 
cmsRun  eleTreeProd_Simon_newRun2Id_833lower.py  

mv -f  tree_testFastSim_TPG_checknow_833lowerNewID.root  /afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/EGamma/ECGelec/test/NewConfigue/.  
