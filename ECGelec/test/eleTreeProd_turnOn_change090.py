...
process.load("EGamma.ECGelec.NtupleProducer_silvia_cfi")
from EGamma.ECGelec.NtupleProducer_silvia_cfi import *
process.produceNtuple = produceNtupleSilvia.clone()
