...
echo "Starting CMSSW" 
cp /afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/EGamma/ECGelec/test/eleTreeProd_Simon_newRun2Id_2015D_2.py .
cd -
#cd \${lxbatchpwd}

echo "Starting CMSSW" 
cmsRun  eleTreeProd_Simon_newRun2Id_2015D_2.py 

mv -f  tree_testFastSim_TPG_checknow_2015D_14_10_2.root  /afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/EGamma/ECGelec/test/NewConfigue/.  
