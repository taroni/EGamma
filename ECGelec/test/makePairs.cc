...
void makePairs(string file, int nEntries, string dirOut, TString dirIn, TString data, string nameChain, TString RunPhase, bool debug);
...
int main(int argc, char**argv){
  ...
  makePairs(file, -1, "makePairsDir",  "/afs/cern.ch/work/t/taroni/private/ECAL/EcalEleStudy/CMSSW_7_4_12/src/EGamma/ECGelec/test/", "Run2015D", "produceNtuple/eIDSimpleTree", "2015D", false) ;
...
void makePairs(string file, int nEntries,  string dirOut, TString dirIn, TString data, string nameChain,  TString RunPhase, bool debug){
  ...
  string eosdir; 
  eosdir="root://eoscms//eos/cms/store/user/taroni/TriggerOptimizationEE/";
  vector<string> files; 
  
  files.push_back(file.c_str());
  // files.push_back("Tutanon/tree_changed.root");
  // files.push_back("Tutanon/tree_noChange.root"); 
  // files.push_back("Tutanon/tree_changed_080.root");
  // files.push_back("Tutanon/tree_changed_085.root");
  // // files.push_back("Tutanon/tree_changed_091.root");
  // // files.push_back("Tutanon/tree_changed_092.root");
  // // files.push_back("Tutanon/tree_changed_093.root");
  // // files.push_back("Tutanon/tree_changed_094.root");
