...
process.GlobalTag.toGet = cms.VPSet(
  ...
  #  tag = cms.string("EcalTPGLinearizationConst_IOV_255246_beginning_at_1"),
    tag = cms.string("EcalTPGLinearizationConst_weekly_notranspcorr"),
...
#process.EcalTrigPrimESProducer.DatabaseFile = 'TPG_beamv6_trans_253217_spikekill_2015.tar.gz'
...
process.TFileService = cms.Service ("TFileService", 
                                    fileName = cms.string ("tree_testFastSim_TPG_checknow_debug254916_254833debug.root")
                                    )
