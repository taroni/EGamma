...
echo "Starting CMSSW" 
cp /afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/EGamma/ECGelec/test/eleTreeProd_Simon_newRun2Id_2015D.py .
cd -
#cd \${lxbatchpwd}

echo "Starting CMSSW" 
cmsRun  eleTreeProd_Simon_newRun2Id_2015D.py 

mv -f  tree_testFastSim_TPG_checknow_2015D_14_10.root  /afs/cern.ch/work/f/fmeng/FANBOWORKINGAREA/CMSSW_7_4_12/src/EGamma/ECGelec/test/NewConfigue/.  
