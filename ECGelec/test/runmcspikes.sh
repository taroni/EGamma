...
#    for myfile in `/afs/cern.ch/project/eos/installation/0.3.84-aquamarine/bin/eos.select ls store/data/$dataset/000/${pathrunnb}/00010` 
    #for myfile in `/afs/cern.ch/project/eos/installation/0.3.84-aquamarine/bin/eos.select ls store/express/$dataset/000/${pathrunnb}/00010`
    for myfile in `/afs/cern.ch/project/eos/installation/0.3.84-aquamarine/bin/eos.select ls /store/group/dpg_ecal/comm_ecal/spikeStudies/MinBias_TuneA2MB_13TeV-pythia8/crab_MinBias_PU40x25_Spikes_V41lumi/150427_124156/0001`
     do
      echo $myfile 
      #path2file=/store/data/$dataset/000${pathrunnb}/00010
      #path2file=/store/express/$dataset/000/${pathrunnb}/00010
      s=$[$s+1]
...
#      cp -r configuration/configTPGtemplate.py $batchdir/runTPG_cfg_${s}.py
	  ...
	  -e "s,%filename%,root://eoscms//eos/cms/store/group/dpg_ecal/comm_ecal/spikeStudies/MinBias_TuneA2MB_13TeV-pythia8/crab_MinBias_PU40x25_Spikes_V41lumi/150427_124156/0001/$myfile,"      \
	  -e "s,%isMC_%,$isMC," \
          -i runTPG_cfg_${s}.py
          #-e "s,%filename%,/store/express/$dataset/000/${pathrunnb}/00010/$myfile,"      \
