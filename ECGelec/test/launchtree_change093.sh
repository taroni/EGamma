#!/bin/bash
    ...
    make runPairs JOBID=ratioScan/ZeroBias/TurnOn2015D FILE=tree_change093.root

    cmsStage ratioScan/ZeroBias/TurnOn2015D/makePairsDir/elepairs_tree_change093.root  /store/caf/user/taroni/TestTriggerOptimization2015/ratioScan/Tutanon/makePairsDir/
