#!/bin/bash
    ...
    make runSelect JOBID=ratioScan/TurnOn2015/ FILE=tree_change085.root

    cmsStage -f ratioScan/TurnOn2015/selectPairsDir/effi_TagProbe_tree_change085.root  /store/caf/user/taroni/TestTriggerOptimization2015/ratioScan/TurnOn2015/selectPairsDir/
