...
execfile(PyFilePath + "eleTreeProd_L1Study_2015.py",namespace)
print len(namespace)
...
if options.tag=='':
    filesuffix = ""
process.TFileService.fileName = cms.string(options.filePrepend+"tree_L1"+filesuffix+"xxxxxxxxxxxxxxxx.root")
...
process.GlobalTag.globaltag = '74X_dataRun2_Prompt_v1'#'74X_dataRun2_v2'
if bool(options.isMC) and options.globaltag=='NOT_PROVIDED':
  ...
  my_global_tag='74X_dataRun2_Prompt_v1'#'74X_dataRun2_v2'
else:
...
process.MyHLTSelection.HLTPaths = cms.vstring(
